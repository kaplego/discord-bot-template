...
declare interface Event<K extends keyof Discord.ClientEvents> {
	 ...
	 */
	listener: (data: [...Discord.ClientEvents[K]], client: Discord.Client) => Promise<void> | void;
}
...
> {
	 ...
	 * @param client Le client Discord.js.
	 */
	execute: (interaction: I, client: Discord.Client) => Promise<unknown> | unknown;
}

/**
 * Représente une commande slash.
 */
declare interface SlashCommand extends Command<Discord.ChatInputCommandInteraction> {
 ...
 */
declare interface MessageCommand extends Command<Discord.MessageContextMenuCommandInteraction> {
 ...
 */
declare interface UserCommand extends Command<Discord.UserContextMenuCommandInteraction> {
...
declare interface BaseComponent<I extends Discord.AnyComponentInteraction> {
	...
	component: {
		...
		id: string;
		/**
		 * Une expression régulière à définir si l'identifiant du composant est dynamique,
         * ou si le fichier valide plusieurs boutons
		 */
		regex?: RegExp;
	};
	execute: (interaction: I, client: Discord.Client) => Promise<unknown> | unknown;
...
declare interface BaseSelectMenu<
	_T extends Discord.SelectMenuType,
 ...
 */
declare interface AnySelectMenu extends BaseSelectMenu<Discord.SelectMenuType, Discord.AnySelectMenuInteraction> {}

/**
 * Représente un menu de sélection de salons.
 */
declare interface ChannelSelectMenu
	extends BaseSelectMenu<Discord.ComponentType.ChannelSelect, Discord.ChannelSelectMenuInteraction> {}

/**
 * Représente un menu de sélection de mentionables (rôles ou utilisateurs).
 */
declare interface MentionableSelectMenu
	extends BaseSelectMenu<Discord.ComponentType.MentionableSelect, Discord.MentionableSelectMenuInteraction> {}

/**
 * Représente un menu de sélection de rôles.
 */
declare interface RoleSelectMenu
	extends BaseSelectMenu<Discord.ComponentType.RoleSelect, Discord.RoleSelectMenuInteraction> {}

/**
 * Représente un menu de sélection d'utilisateurs.
 */
declare interface UserSelectMenu
	extends BaseSelectMenu<Discord.ComponentType.UserSelect, Discord.UserSelectMenuInteraction> {}

/**
 * Représente un menu de sélection de chaînes de caractères.
 */
declare interface StringSelectMenu
	extends BaseSelectMenu<Discord.ComponentType.StringSelect, Discord.StringSelectMenuInteraction> {}
...
declare interface Autocomplete {
	name: string;
	execute: (interaction: Discord.AutocompleteInteraction, client: Discord.Client) => Promise<unknown> | unknown;
}
